...
namespace Test
{
  ...
  public class TestLinijskogPucača
  {
    ...
    [TestMethod]
    public void LinijskiPucač_GađajVraćaSlobodnoPoljeLijevoOdHorizontalnogNiza()
    {
      Mreža m = new Mreža(10, 10);
      Polje[] polja = { new Polje(2, 3), new Polje(2, 4) };
      m.UkloniPolje(2, 5);
    ...
    [TestMethod]
    public void LinijskiPucač_GađajVraćaSlobodnoPoljeDesnoOdHorizontalnogNiza()
    {
      Mreža m = new Mreža(10, 10);
      Polje[] polja = { new Polje(2, 2), new Polje(2, 4) };
      m.UkloniPolje(2, 5);
      LinijskiPucač puc = new LinijskiPucač(m, polja, 3);
